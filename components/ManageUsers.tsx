        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Below is the users who have access to this Doc.
                    </DialogDescription>
                </DialogHeader>
                <hr className="my-2" />
                <div className="flex flex-col space-y-2">
                    {usersInRoom?.docs.map((doc) => (
                        <div key={doc.data().userId} className="flex flex-row justify-between">
                            <p className="font-bold items-center my-auto">
